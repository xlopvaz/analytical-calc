...
// Two-tailed t-value at 95% confidence, indexed by degrees of freedom (n-2).
// Standard statistics table (e.g. any analytical chemistry textbook appendix).
const T95_TABLE = {
...
/** Returns the two-tailed t-value at 95% confidence for the given degrees of freedom, or null if df <= 0. */
